...
public:
	...
	inline static int NbVBOFacesRendered; ///< Nombre de faces rendues par les VBO, incr�ment�es par eux a chaque frames 
...
private:
	...
	//Matrices sauv�es, a passer aux shaders, calcul�es depuis les matrices OGL
	YMat44 MatM;
	YMat44 MatV;
	YMat44 MatP;
	YMat44 MatNorm;
...
public:
	...
	void drawFullScreenQuad() {
		...
		glLoadIdentity(); // R�initialisation

		glMatrixMode(GL_MODELVIEW); // on repasse en mode matrice mod�le
		glLoadIdentity(); // R�initialisation
	...
	void render(float elapsed)
	{
		...
		Camera->look(); //Initialise la matrice MV � V
		...
		//On fait le rendu 2D sur l'�cran
	...
	/**
		* Permet de cr�er un programme de shaders, a activer quand on veut
		*/
